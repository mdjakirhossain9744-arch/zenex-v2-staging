...
export default function GetNumber() {
  ...
  // 💥 FIXED SCROLL OBSERVER - Now triggers slightly earlier to ensure smooth scroll 💥
  useEffect(() => {
  ...
  return (
    <DashboardLayout>
      <div className="p-3 md:p-10 w-full relative z-10 font-sans flex flex-col h-[100vh] overflow-hidden">
        ...
        {/* 💥 FEED CARD (WITH INTERNAL INFINITE SCROLL) 💥 */}
        <div className="rounded-xl bg-[#1E293B]/80 border border-[#334155] backdrop-blur-xl overflow-hidden shadow-md w-full mb-4 flex flex-col h-[65vh] min-h-[400px]">
