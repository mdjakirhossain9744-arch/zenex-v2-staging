      ...
      <div className="p-4 md:p-10 w-full relative z-10 pb-20 font-sans">
        <div className="w-full">
          <div className="mb-6 flex flex-col xl:flex-row justify-between items-start xl:items-center gap-4">
            <div>
              <h2 className="text-2xl md:text-3xl font-black text-[#A855F7] tracking-tight">
                Network Realtime Console
              </h2>
              <div className="flex items-center gap-2 mt-1">
                ...
                <p className="text-[#94A3B8] text-sm font-medium tracking-widest uppercase">
                  Monitoring Agent Network • 50 Rows
                </p>
              </div>
            </div>
          </div>

          {/* 💥 UPDATE: Added max-h-[75vh] and custom-scrollbar to keep 50 rows neatly scrolable inside the card! 💥 */}
                ...
                {liveData.length === 0 && !isValidating ? (
                  <tr>
                    <td colSpan={4} className="p-8 text-center text-[#64748B] font-bold">
                      No live activity found in your network.
                    </td>
                  </tr>
                ) : (
