      ...
      <div className="p-3 md:p-10 w-full relative z-10 pb-20 font-sans">
        <div className="w-full">
          ...
          <div className="mb-6 grid grid-cols-2 md:flex md:flex-row items-center gap-3 bg-[#1E293B]/80 border border-[#334155] p-3 rounded-xl shadow-lg backdrop-blur-md">
            ...
            <select value={limit} onChange={(e) => setLimit(Number(e.target.value))} disabled={!isLive} className="col-span-1 w-full bg-[#0F172A] text-xs md:text-sm font-bold text-[#94A3B8] px-3 md:px-4 py-2.5 rounded-lg border border-[#334155] focus:border-[#3B82F6] focus:text-[#E2E8F0] outline-none transition-all cursor-pointer disabled:opacity-50">
